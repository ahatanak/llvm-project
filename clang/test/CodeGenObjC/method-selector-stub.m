...
int test_root_class0() {
  ...
  // CLASS_STUB: %{{[^ ]*}} = call i32 @"objc_msgSendClass$class0$_OBJC_CLASS_$_Root"(ptr {{[^,)]*}}undef, ptr {{[^,)]*}}undef)
  return [Root class0];
}
...
int test_root2_class0() {
  ...
  // INST_STUB: %{{[^ ]*}} = call i32 @"objc_msgSend$class0"(ptr {{[^,]*}}%{{[^,]+}}, ptr {{[^,)]*}}undef)
  // CLASS_STUB: %{{[^ ]*}} = call i32 @"objc_msgSendClass$class0$_OBJC_CLASS_$_Root2"(ptr {{[^,)]*}}undef, ptr {{[^,)]*}}undef)
  return [Root2 class0];
}
...
int test_class_method_extension(void) {
  ...
  // CLASS_STUB: %{{[^ ]*}} = call i32 @"objc_msgSendClass$classMethodInExtension$_OBJC_CLASS_$_Foo"(ptr {{[^,)]*}}undef, ptr {{[^,)]*}}undef)
...
int test_class_method_category(void) {
  ...
  // CLASS_STUB: %{{[^ ]*}} = call i32 @"objc_msgSendClass$classMethodInCategory$_OBJC_CLASS_$_Foo"(ptr {{[^,]*}}undef, ptr {{[^,)]*}}undef)
...
void test_class_method_objc_runtime_name(void) {
  ...
  // CLASS_STUB: call void @"objc_msgSendClass$m0$_OBJC_CLASS_$__Foo1234"(ptr {{[^,]*}}undef, ptr {{[^,)]*}}undef)
  [Foo2 m0];
}
